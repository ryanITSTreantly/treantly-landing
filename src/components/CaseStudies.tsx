  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 right-0 w-64 h-64 bg-[var(--brand-lime)] rounded-full blur-3xl opacity-20"></div>
        <div className="absolute bottom-0 left-1/4 w-48 h-48 bg-[var(--brand-teal)] rounded-full blur-3xl opacity-10"></div>
      </div>
